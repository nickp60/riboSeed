...
At either 20x or 50x coverage, \textit{de novo} assembly was unable to resolve a single rDNA with any of the simulated read sets. \textit{de fere novo} assembly with riboSeed showed modest improvement to both the \coli{} assemblies. Increasing depth of coverage and read length improves assemblies.
